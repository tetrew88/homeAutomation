...
from homeDatabase.classes.homeDatabase import *
from homeDatabase.classes.users.profil import *
from homeDatabase.classes.users.guest import *
from homeDatabase.classes.users.inhabitant import *
from homeDatabase.classes.users.user import *
from homeDatabase.classes.users.administrator import *
...
class TestHomeDatabase:
    ...
    def test_getting_users_list(self):
        ...
        with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.connect') as mockedDatabaseConnection:
            mockedDatabaseConnection.return_value = True
            self.homeDatabase.db_cursor = FakeSuccesCursor()
            self.homeDatabase.db_cursor.list = [
                (1, 1, "admin", "inhabitant", "tetrew", "0000", "test@test.fr"),
                (1, 1, "user", "inhabitant", "tetrew", "0000", "test@test.fr"),
                (1, 1, "user", "guest", "tetrew", "0000", "test@test.fr")
            ]

            with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.get_profil_by_id') as mockeGettingProfilById:
    ...
    def test_adding_user(self):
        ...
        #test if method return True if succes
        with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.add_profil') as mockedAddingProfil:
            ...
            with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.connect') as mockedDatabaseConnection:
                ...
                with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.commit_change') as mockedCommitingChange:
                    mockedCommitingChange.return_value = True

                    with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.get_users_list') as mockedGettingUsersList:
                        mockedGettingUsersList.return_value = [Administrator(1, Profil(1, "donovan", "maurice", "m", "26/09/1994"), "tetrew" , "0000", "test@test.fr")]

                        assert self.homeDatabase.add_user("donovan", "maurice", "m", "26/09/1994", "admin", "inhabitant", "tetrew", "0000", "test@test.fr") == True


        #test if method detect parametters error
        assert self.homeDatabase.add_user(1, "maurice", "m", "26/09/1994", "admin", "inhabitant", "tetrew", "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", 1, "m", "26/09/1994", "admin", "inhabitant", "tetrew", "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", 1, "26/09/1994", "admin", "inhabitant", "tetrew", "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", "g", "26/09/1994", "admin", "inhabitant", "tetrew", "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", "m", 1, "admin", "inhabitant", "tetrew", "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", "m", "26/09/1994", 1, "inhabitant", "tetrew", "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", "m", "26/09/1994", "random", "inhabitant", "tetrew", "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", "m", "26/09/1994", "admin", 1, "tetrew", "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", "m", "26/09/1994", "admin", "random", "tetrew", "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", "m", "26/09/1994", "admin", "inhabitant", 1, "0000", "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", "m", "26/09/1994", "admin", "inhabitant", "tetrew", 1, "test@test.fr") == False
        assert self.homeDatabase.add_user("donovan", "maurice", "m", "26/09/1994", "admin", "inhabitant", "tetrew", 1, 1) == False
            ...
            with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.connect') as mockedDatabaseConnection:
                ...
                with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.commit_change') as mockedCommitingChange:
                    ...
                    with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.get_users_list') as mockedGettingUsersList:
                        ...
                        assert self.homeDatabase.add_user("donovan", "maurice", "m", "26/09/1994", "admin", "inhabitant", "tetrew", "0000", "test@test.fr") == False
    ...
    def test_adding_profil(self):
        ...
        with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.connect') as mockedDatabaseConnection:
            ...
            with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.commit_change') as mockedCommitingChange:
                ...
                with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.get_profils_list') as mockedGettingProfilsList:
    ...
    def test_checking_database_connection(self):
        ...
        with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.connect') as mockedDatabaseConnection:
            ...
            with mock.patch('homeDatabase.classes.homeDatabase.HomeDatabase.disconnect') as mockedDatabaseDisconnection:
