...
from homeDatabase.classes.databaseInstaller import *
...
class TestDatabaseInstaller:
    ...
    def test_creating_database(self, mock_subproc_popen):
        ...
        with mock.patch('homeDatabase.classes.databaseInstaller.DatabaseInstaller.check_database_existence') as mockedMethod:
    ...
    def test_creating_database_system_user(self, mock_subproc_popen):
        ...
        with mock.patch('homeDatabase.classes.databaseInstaller.DatabaseInstaller.check_database_user_existence') as mockedMethod:
            mockedMethod.return_value = True
            assert self.databaseInstaller.create_database_system_user("testUser", "testDatabase") == True
    ...
    def test_user_system_privilege_attribution(self, mock_subproc_popen):
        ...
        with mock.patch('homeDatabase.classes.databaseInstaller.DatabaseInstaller.check_database_user_existence') as mockedUserControl:
            mockedUserControl.return_value = True
            with mock.patch('homeDatabase.classes.databaseInstaller.DatabaseInstaller.check_database_existence') as mockedDatabaseControl:
